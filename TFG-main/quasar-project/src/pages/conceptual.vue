<template>
  <q-page padding>
    <!-- Cabecera -->
    <div class="q-mb-lg">
      <div class="header-title">Conceptual</div>
    ...
    <div v-if="loading" class="text-center q-mt-xl">
      ...
      <div class="q-mt-md text-grey-8">Cargando historias del diseño Conceptual...</div>
    </div>
...
.donut-container-small { width: 160px; height: 160px; margin: auto; }
</style>
